...
CONTAINS
  !
  SUBROUTINE Initcoll_N2_O2(vr,omega_a,omega_b,y)
    USE Norm_vars_no
    USE Random
    IMPLICIT NONE
    ...
    y(16:18)=vb
    !
  END SUBROUTINE Initcoll_N2_O2
  !
  SUBROUTINE CT_N2_O2(vr,omega_a,omega_b,status)
    USE Norm_vars_no
    USE Pot_N2_O2
    USE Setup, ONLY:h
    IMPLICIT NONE
    INTEGER,INTENT(OUT)::Status
    CHARACTER, PARAMETER:: Nitrogen='N',Oxygen='O'
    ...
    ! Dati Iniziali
    !
    CALL Initcoll_N2_O2(vr,omega_a,omega_b,y)
    !
    ...
    omega_a=omega_a/dnn**2;omega_b=omega_b/doo**2
    !
    ...
    DO WHILE(rho.LT.1.005D0*rho_in)
       CALL RK4_N2_O2(h,t,y)
       !
       DO ieq=1,18
          IF(ISNAN(y(ieq)).EQV..TRUE.)THEN
             Status=ieq
             WRITE(15,*)'N2-O2','NaN in y(',ieq,')'
!!$             WRITE(15,*)'NaN in y(',ieq,')'
!!$             WRITE(15,200)y(1:3),y(8:10)
!!$             WRITE(15,200)y(4:5),y(11:12)
!!$             WRITE(15,200)y(6:7),y(13:14)
             EXIT
          END IF
       END DO
       !
...
!!$       angmom=angmom+Ia*Omega_a+Ib*Omega_b
!!$       !
...
111 CONTINUE
  END SUBROUTINE CT_N2_O2
  !
  SUBROUTINE RK4_N2_O2(h,x,y)
  IMPLICIT NONE
  INTEGER, PARAMETER::neqmax=18
  ...
  REAL(dp)::x,x1,h
  !
  CALL ydot_n2_o2(y,dydx)
  !
  k1=dydx*h;y1=y+k1*0.5D0;x1=x+h*0.5D0 
  !
  CALL ydot_n2_o2(y1,dydx)
  !
  ...
  !
END SUBROUTINE RK4_N2_O2
!
SUBROUTINE Ydot_N2_O2(y,dydt)
  USE Norm_vars_no
  USE Pot_N2_O2
  IMPLICIT NONE
  INTEGER, PARAMETER::neqmax=18
  ...
  !
  CALL vno_derivatives(R,ra,rb,fr,fa,fb)
  fr=-fr;fa=-fa;fb=-fb;
  !
  dydt(1:9)=y(10:18)
  dydt(10:12)=fr/mr
  ...
  !
END SUBROUTINE Ydot_N2_O2
!
END MODULE Coll_N2_O2
