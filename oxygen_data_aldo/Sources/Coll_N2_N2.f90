...
CONTAINS
  !
  SUBROUTINE Initcoll_N2_N2(vr,omega_a,omega_b,y)
    USE Norm_vars_nn
    USE Random
    IMPLICIT NONE
    ...
    !
    epsilon=pi2*rf(seme)
    ra=COS(epsilon)*J+SIN(epsilon)*K;ra=ra*dnn
    ...
    !
    epsilon=pi2*rf(seme)
    rb=COS(epsilon)*J+SIN(epsilon)*K;rb=rb*dnn
    ...
    y(16:18)=vb
    !
  END SUBROUTINE Initcoll_N2_N2
  !
  SUBROUTINE CT_N2_N2(vr,omega_a,omega_b,status)
    USE Norm_vars_nn
    USE Pot_N2_N2
    USE Setup, ONLY:h
    IMPLICIT NONE
    INTEGER,INTENT(OUT)::Status
    CHARACTER, PARAMETER:: Nitrogen='O'
    ...
    ! Dati Iniziali
    !
    CALL Initcoll_N2_N2(vr,omega_a,omega_b,y)
    !
    ...
    omega_a=omega_a/dnn**2;omega_b=omega_b/dnn**2
    !
    ...
    DO WHILE(rho.LT.1.005D0*rho_in)
       !
       CALL RK4_N2_N2(h,t,y)
       !
       DO ieq=1,18
          IF(ISNAN(y(ieq)).EQV..TRUE.)THEN
             Status=ieq
             WRITE(14,*)'N2-N2  ', 'NaN in y(',ieq,')'
!!$             WRITE(14,*)'NaN in y(',ieq,')'
!!$             WRITE(14,200)y(1:3),y(8:10)
!!$             WRITE(14,200)y(4:5),y(11:12)
!!$             WRITE(14,200)y(6:7),y(13:14)
             EXIT
          END IF
       END DO
       !
...
!!$          WRITE(10,*)4
!!$          WRITE(10,*)'# Tempo=',t
!!$          WRITE(10,100)Nitrogen,ra1
!!$          WRITE(10,100)Nitrogen,ra2
!!$          WRITE(10,100)Nitrogen,rb1
!!$          WRITE(10,100)Nitrogen,rb2
!!$          !
!!$       END IF
!!$       step=step+1
...
!!$       !
    ...
    !
    !WRITE(11,200)impact_parameter**2,deflection_vr
    !
!!$100 FORMAT(A1,2x,3(e12.5,2x))
!!$200 FORMAT(12(e12.5,2x))
111 CONTINUE
  END SUBROUTINE CT_N2_N2
  !
  SUBROUTINE RK4_N2_N2(h,x,y)
    IMPLICIT NONE
    INTEGER, PARAMETER::neqmax=18
    ...
    REAL(dp)::x,x1,h
    !
    CALL ydot_n2_n2(y,dydx)
    !
    k1=dydx*h;y1=y+k1*0.5D0;x1=x+h*0.5D0 
    !
    CALL ydot_n2_n2(y1,dydx)
    !
    ...
    !
  END SUBROUTINE RK4_N2_N2
  !
  SUBROUTINE Ydot_N2_N2(y,dydt)
    USE Norm_vars_nn
    USE Pot_N2_N2
    IMPLICIT NONE
    INTEGER, PARAMETER::neqmax=18
    ...
    vr=y(10:12);va=y(13:15);vb=y(16:18);
    !
    lambda_a=-ma*DOT_PRODUCT(va,va)/(4.0D0*dnn**2)
    lambda_b=-mb*DOT_PRODUCT(vb,vb)/(4.0D0*dnn**2)
    !
    CALL vnn_derivatives(R,ra,rb,fr,fa,fb)
    fr=-fr;fa=-fa;fb=-fb;
    dydt(1:9)=y(10:18)
    dydt(10:12)=fr/mr
    ...
    !
  END SUBROUTINE Ydot_N2_N2
  !
END MODULE Coll_N2_N2
