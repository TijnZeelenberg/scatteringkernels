#!/bin/bash
# Run from inside the Build_exe/ directory, then execute the resulting tpropts_O2 executable from the Run/ directory.
gfortran -O3 -march=native -o ../Run/tprops_O2 ../Sources/Tprops_O2.f90 \
